"""
Agent 1 — Bengaluru Weather
Fetches current weather and 3-day forecast for Bengaluru
...
def fetch() -> dict:
    """Return raw weather JSON for Bengaluru."""
...
def get_summary() -> dict:
    """Return a simplified summary dict for Bengaluru."""
    data = fetch()
